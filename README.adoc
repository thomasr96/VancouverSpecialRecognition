...
.src/main/java/com/thomasretzloff/payroll/Employee.java
====
[source,java]
----
include::src/main/java/com/thomasretzloff/payroll/Employee.java[tag=code]
----
...
.src/main/java/com/thomasretzloff/payroll/EmployeeRepository.java
====
[source,java]
----
include::src/main/java/com/thomasretzloff/payroll/EmployeeRepository.java[tag=code]
----
...
.src/main/java/com/thomasretzloff/payroll/DatabaseLoader.java
====
[source,java]
----
include::src/main/java/com/thomasretzloff/payroll/DatabaseLoader.java[tag=code]
----
...
.src/main/java/com/thomasretzloff/payroll/ReactAndSpringDataRestApplication.java
====
[source,java]
----
include::src/main/java/com/thomasretzloff/payroll/ReactAndSpringDataRestApplication.java[tag=code]
----
====
...
.src/main/java/com/thomasretzloff/payroll/HomeController.java
====
[source,java]
----
include::src/main/java/com/thomasretzloff/payroll/HomeController.java[tag=code]
----
